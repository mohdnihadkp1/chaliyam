    ...
    <div className="py-4 md:py-6 px-3 md:px-4 max-w-7xl mx-auto animate-[fadeUp_0.4s_ease]">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 md:gap-4 mb-5 md:mb-8">
        <div>
          <h2 className="font-yatra text-xl md:text-3xl mb-1 md:mb-1.5 flex items-center gap-2 md:gap-3 bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
            <Newspaper className="text-gold-light w-6 h-6 md:w-7 md:h-7" />
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 bg-gold/20 border border-gold/30 text-gold-light px-3.5 py-2 md:px-4 md:py-2.5 rounded-lg md:rounded-xl font-medium hover:bg-gold/30 transition-colors shadow-inner backdrop-blur-md text-sm md:text-base"
        >
          <Plus size={18} />
          Submit News
        </button>
      ...
      <div className="flex flex-col md:flex-row gap-2.5 md:gap-3 mb-4 md:mb-6">
        <div className="relative flex-1">
          <Search className="absolute left-3 md:left-3.5 top-1/2 -translate-y-1/2 text-slate-400 w-4 h-4 md:w-[18px] md:h-[18px]" />
          <input 
            type="text" 
            placeholder="Search news, events, announcements..." 
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full pl-9 md:pl-10 pr-3 md:pr-4 py-2.5 md:py-3 rounded-lg md:rounded-xl border border-white/10 bg-white/5 backdrop-blur-md text-xs md:text-sm font-sans text-slate-200 outline-none transition-colors focus:border-gold/50 placeholder:text-slate-500 shadow-inner"
          />
        </div>
        <div className="relative">
          <input 
            ...
            className="w-full md:w-auto px-3 md:px-4 py-2.5 md:py-3 rounded-lg md:rounded-xl border border-white/10 bg-white/5 backdrop-blur-md text-xs md:text-sm font-sans text-slate-200 outline-none transition-colors focus:border-gold/50 shadow-inner"
          />
          {filterDate && (
            <button 
        ...
        <select
          ...
          className="px-3 md:px-4 py-2.5 md:py-3 rounded-lg md:rounded-xl border border-white/10 bg-slate-900 text-xs md:text-sm font-sans text-slate-200 outline-none transition-colors focus:border-gold/50 appearance-none cursor-pointer min-w-[120px] md:min-w-[140px] shadow-inner"
        >
            ...
            return (
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <h3 
                    className="text-[15px] font-semibold text-slate-200 mb-2 hover:text-gold-light transition-colors cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                      toggleExpand(index);
                    }}

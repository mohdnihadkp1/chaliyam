...
export default function Home() {
 ...
 `/directory?search=${encodeURIComponent(searchQuery)}`,
 );
 };
...
"bg-[var(--color-primary-container)] text-[var(--color-primary)]",
 ...
 const secondaryActions = [
  ...
  <div className="bg-[var(--color-primary)] text-[var(--color-on-primary)] pt-6 px-4 md:px-8 pb-10 rounded-b-[40px] shadow-sm relative overflow-hidden">
  {""}
  ...
  <div className="-mx-4 md:-mx-8">
    <StoriesSection />
      ...
      <div className="max-w-7xl mx-auto pt-4 md:pt-6 px-4 md:px-8 -mt-10 relative z-30 mb-6 md:mb-8 animate-fade-in-up">
        <div className="group relative w-full flex flex-col md:flex-row bg-white rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl border border-[var(--color-outline)] transition-all duration-500 hover:shadow-indigo-500/20">
          ...
          {/* Image Section */}
          <div className="relative w-full md:w-1/2 h-44 md:h-auto md:min-h-[300px] overflow-hidden">
            <img 
          ...
          {/* Content Section */}
          <div className="relative w-full md:w-1/2 p-5 md:p-8 lg:p-10 flex flex-col justify-center bg-slate-900 text-white overflow-hidden">
            {/* Background pattern */}
            ...
            <div className="relative z-10 flex flex-col items-start h-full justify-center">
              ...
              <h2 className="text-2xl md:text-4xl lg:text-5xl font-extrabold mb-3 md:mb-4 tracking-tight leading-tight">
                Calicut <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">Store</span>
              </h2>
              
              <p className="text-slate-300 text-xs md:text-base font-medium mb-5 md:mb-8 leading-relaxed max-w-md">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-20 mb-6">
        <div className="relative w-full h-48 md:h-56 rounded-2xl overflow-hidden shadow-lg border border-[var(--color-outline)] cursor-pointer active:scale-[0.98] transition-transform duration-300 group">
 ...
 className="bg-[var(--color-surface)] border border-[var(--color-outline)] rounded-3xl p-5 flex flex-col items-center justify-center gap-3 cursor-pointer hover:shadow-md transition-all duration-300 group shadow-sm active:scale-95"
 >
 {""}
 <div
 className={`p-4 rounded-3xl ${action.color} group-hover:scale-110 transition-transform duration-300`}
 >
 {""}
 <action.icon size={36} strokeWidth={2} />{""}
 </div>{""}
 <div className="font-bold text-sm md:text-base text-[var(--color-on-surface)] text-center tracking-wide">
 {action.label}
 </div>{""}
 </div>
 ))}{""}
 ...
 className="bg-red-50 border border-red-200 rounded-3xl p-5 flex items-center justify-between cursor-pointer hover:shadow-md transition-all duration-300 group shadow-sm active:scale-95"
 >
 {""}
 <div className="flex items-center gap-4">
 {""}
 <div className="bg-[var(--color-danger)] text-white p-3 rounded-2xl group-hover:scale-110 transition-transform duration-300 shadow-sm">
 {""}

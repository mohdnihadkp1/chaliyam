    ...
    <div className="py-6 md:py-10 px-4 md:px-6 max-w-7xl mx-auto animate-[fadeUp_0.4s_ease]">
      ...
      <div className="flex flex-col md:flex-row gap-3 mb-6">
        ...
        <select
          ...
          className="px-4 py-3 rounded-xl border-[1.5px] border-white/10 bg-slate-900 text-sm font-sans text-slate-200 outline-none transition-colors focus:border-gold/50 appearance-none cursor-pointer min-w-[160px] shadow-inner"
        >

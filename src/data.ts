...
export const DIRECTORY = [
  { name: "Fresh Fish Market", cat: "fishing", catLabel: "Fishing", desc: "Daily fresh catch from local fishermen. Open 5AM–10AM.", rating: 4.8, reviews: 124 },
  { name: "Chaliyam Tiffin Centre", cat: "food", catLabel: "Food", desc: "Traditional Kerala breakfast and meals. Puttu, Kanji, Appam.", rating: 4.5, reviews: 89 },
  { name: "Sree Medicals", cat: "medical", catLabel: "Medical", desc: "24-hour pharmacy. All branded & generic medicines available.", rating: 4.2, reviews: 56 },
  { name: "Boat Repair & Service", cat: "fishing", catLabel: "Fishing", desc: "Fiberglass boats, engine repair, nets & equipment.", rating: 4.6, reviews: 42 },
  { name: "Al-Ameen Supermarket", cat: "retail", catLabel: "Retail", desc: "Groceries, household items, fresh vegetables & dairy.", rating: 4.3, reviews: 112 },
  { name: "Chaliyam Auto Works", cat: "service", catLabel: "Services", desc: "Car, bike, auto repair. Electrical and AC service.", rating: 4.0, reviews: 38 },
  { name: "Kerala Bakery", cat: "food", catLabel: "Food", desc: "Fresh bread, snacks, cakes and traditional Kerala sweets.", rating: 4.7, reviews: 156 },
  { name: "Mobile Repair Shop", cat: "service", catLabel: "Services", desc: "iPhone, Android repair, accessories, SIM services.", rating: 3.9, reviews: 27 },
  { name: "Chaliyam Tuition Centre", cat: "service", catLabel: "Services", desc: "Coaching for Classes 1–12. CBSE and State syllabus.", rating: 4.9, reviews: 65 },
  { name: "Gents Saloon", cat: "service", catLabel: "Services", desc: "Haircut, shave, facial — traditional Kerala barber shop.", rating: 4.4, reviews: 73 },
  { name: "Fishing Net Supplier", cat: "fishing", catLabel: "Fishing", desc: "Nylon nets, hooks, floats, fishing accessories wholesale.", rating: 4.5, reviews: 31 },
  { name: "Chaliyam Clinic", cat: "medical", catLabel: "Medical", desc: "General physician. Morning & evening OPD. Home visits available.", rating: 4.8, reviews: 92 },
  { name: "Vegetable Stall", cat: "retail", catLabel: "Retail", desc: "Fresh local vegetables and fruits. Available from 7AM daily.", rating: 4.1, reviews: 45 },
  { name: "Electrical Works", cat: "service", catLabel: "Services", desc: "Home wiring, appliance repair, solar panel installation.", rating: 4.3, reviews: 29 },
  { name: "Book & Stationery Store", cat: "retail", catLabel: "Retail", desc: "School books, stationery, greeting cards, gift items.", rating: 4.6, reviews: 84 },
  { name: "Ice Cream & Juice Corner", cat: "food", catLabel: "Food", desc: "Fresh fruit juices, ice cream, milkshakes. Perfect for summer.", rating: 4.7, reviews: 108 },
];

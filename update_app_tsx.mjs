...
const appCode = `import { useEffect } from 'react';
...
// Now we need to update DirectorySection, MarketplaceSection, NewsSection, SpotsSection, PeopleSection
// to use \`searchParams\` for URLs, and also add JSON-LD where applicable.
